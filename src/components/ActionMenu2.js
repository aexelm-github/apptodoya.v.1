...
const ActionMenu2 = (props) => {
    //const {estosBotonesActivos = {}, onPress, callbackFromParent } = props;
    return (
        <View style={styles.actionBar}>
        {
            props.estosBotonesActivos.add ? (
                <TouchableOpacity activeOpacity={0.7}
                    onPress={() => {props.callbackFromParent('add') }}
                >
        ...
        {
            props.estosBotonesActivos.delete ? (
                <TouchableOpacity activeOpacity={0.7}
                    onPress={() => {props.callbackFromParent('delete') }}
                >
        ...
        {
            props.estosBotonesActivos.edit ? (
                <TouchableOpacity activeOpacity={0.7}
                    onPress={() => {props.callbackFromParent('edit') }}
                >
